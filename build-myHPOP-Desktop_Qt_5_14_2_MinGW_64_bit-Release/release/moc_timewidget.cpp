...
QT_MOC_LITERAL(1, 11, 19), // "sendTimeCountSignal"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 1) // "m"

    },
    "TimeWidget\0sendTimeCountSignal\0\0m"
};
...
void TimeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TimeWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeWidget::sendTimeCountSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TimeWidget::sendTimeCountSignal(int _t1)
{
